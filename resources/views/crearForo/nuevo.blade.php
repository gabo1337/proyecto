...
@section('pagina')
 <div class = "container">
     ...
     <div class="row justify-content-center">
         ...
         @endif
         <form action="{{url('/foros/crear')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                   ...
                   <div class="form-group">
                    <label for="color1" class="col-sm12 col-form-label">
                        {{__('Color1')}}
                    </label>
                    <div class="col-sm-12">
                    <input type="text" id="color1" name="color1" class="form-control {{$errors-> has('color1') ? ' is-invalid':''}}" value="{{old('color1')}}" autofocus>
                   ...
                   <div class="form-group">
                    <label for="color2" class="col-sm12 col-form-label">
                        {{__('Color2')}}
                    </label>
                    <div class="col-sm-12">
                    <input type="text" id="color2" name="color2" class="form-control {{$errors-> has('color2') ? ' is-invalid':''}}" value="{{old('color2')}}" autofocus>
                   ...
                   <div class="form-group">
                    <div class="col-sm-12">
                        <div class="custom-file">
                            ...
                            <label for="customFile" class="custom-file-label">{{__('choose icon')}}</label>
